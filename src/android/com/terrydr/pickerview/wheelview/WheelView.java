...
package com.terrydr.pickerview.wheelview;

import java.util.LinkedList;
import java.util.List;
import com.terrydr.pickerview.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.pickerview_wheel_bg;
	private int wheelForeground = R.drawable.pickerview_wheel_val;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.pickerview_province_line_border));
		// 设置线宽
